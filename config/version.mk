...
EXTENDED_DATE_TIME_UTC := $(shell date -u +'$(EXTENDED_DATE_YEAR)-$(EXTENDED_DATE_MONTH)-$(EXTENDED_DATE_DAY) $(EXTENDED_DATE_HOUR):$(EXTENDED_DATE_MINUTE)')
EXTENDED_BUILD_DATE_UTC := $(shell date -d '$(EXTENDED_DATE_TIME_UTC)' +%s)
