...
ifeq ($(USE_GCC_arm64),true)
    ...
    TARGET_KERNEL_CROSS_COMPILE_ARM32 := $(shell pwd)/prebuilts/gcc/linux-x86/arm/arm-linux-gnueabi-9.1/bin/arm-eabi-
endif
...
ifeq ($(USE_GCC_arm),true)
    ...
    KERNEL_TOOLCHAIN := $(shell pwd)/prebuilts/gcc/linux-x86/arm/arm-linux-gnueabi-9.1/bin
endif
